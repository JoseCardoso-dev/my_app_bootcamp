...
enum STORAGE_CHAVES {
  ...
  CHAVE_QUANTIDADE_CLICK
}

class AppStorageService {
  Future<void> setQuantidadeClicks(int value) async {
    await _setInt(STORAGE_CHAVES.CHAVE_QUANTIDADE_CLICK.toString(), value);
  }

  Future<int> getQuantidadeClicks() async {
    return _getInt(STORAGE_CHAVES.CHAVE_QUANTIDADE_CLICK.toString());
  }
